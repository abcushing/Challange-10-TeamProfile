...
},
{
    ...
    const manager=new Manager(responses.manager,responses.id,responses.email,responses.officeNumber)
    ...
    .then(function(response){
        if (response.choice==='add engineer'){
            ...
            },
            {
                ...
                const engineer=new Engineer(responses.engineer,responses.id,responses.email,responses.github)
            ...
            },
            {
                ...
                const intern=new intern(responses.intern,responses.id,responses.email,responses.school)
